...
Ans:- Developers use git to track the version and check the changes made in the two versions
also used to revert the versions when needed.
...
3.Common problems git solve.
 ...
 Git :- Git is a version control system tool and used to the track the changes made in the code.
 Github:- Github is the online platform which is used to save the changes made and create the repositories and collaborate with others.
 because of github we can share our code with other person.
